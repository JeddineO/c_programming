...
{
    int change;
    Cellule *ptr1, *ptr2; // d�claration d'un poinetrur
    ...
    while (ptr1)
    {
        ...
        while (ptr2)  //
        {
            if (ptr2->info > ptr1->info) // cas ou un elemnt est inf�rieur d'un elemnt suivant dans laliste
            {
...
int main()
{
    ...
    do
    {
        ...
        printf("ins�rer un �l�ment dans la liste ----------------------------------------------------2 \n");
        printf("supprimer un �l�ment dans la liste --------------------------------------------------3 \n");
